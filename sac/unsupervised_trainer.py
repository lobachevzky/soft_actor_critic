        ...
        if self.buffer_ready():
            ...
            for i in range(self.n_train_steps):
                if self.boss_state.history is not None:
                    ...
                    delta_tde = old_delta_tde + self.alpha * (
                        new_delta_tde - old_delta_tde)
                    train_delta_tde = train_post_td_error - train_pre_td_error
                    ...
                    # )
                    history = np.hstack([train_result['Q_error'], train_delta_tde])
